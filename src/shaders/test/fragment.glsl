...
{
    return fract(sin(dot(st.xy, vec2(12.9090, 78.233))) * 43758.5453123);
}
...
{ 
    ...
    //pattern 8 solution 2
    /*float strength = mod(vUv.y * 10.0, 1.0);
    strength = strength < 0.5 ? 0.0 : 1.0; */

    //pattern 8 solution 3
    /*float strength = mod(vUv.y * 10.0, 1.0);
    ...
    //patern 27 - one approach
    //float strength = length(vUv - 0.5);

    //patern 27 - another approach
